                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <form id="editForm3" method="POST" action="https://dash.yekbun.net/album/3" enctype="multipart/form-data">
                                                <input type="hidden" name="_token" value="vZWRWLao4mkM3TaLxw8oI60YJ7wrJHownfBORslo"> <input type="hidden" name="_method" value="put">
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="dropzone needsclick dz-clickable dz-started" action="/" id="dropzone-img3">
                                                                            ...
                                                                            <div class="row dz-image-preview" data-path="">
                                                                                <div class="col-md-12 col-12 d-flex justify-content-center">
                                                                                    <div class="dz-preview dz-file-preview w-100">
                                                                                        <div class="dz-details">
                                                                                            <div class="dz-thumbnail" style="width:95%"> <img data-dz-thumbnail="" class="w-100" alt="undefined" src="https://dash.yekbun.net/storage"> <span class="dz-nopreview">No preview</span>
                                                                                            ...
                                                                                            <div class="dz-filename" data-dz-name="">undefined</div>
                                                                                            <div class="dz-size" data-dz-size=""><strong>0.8</strong> KB</div>
                                                                                        </div>
                                                                                    </div>
                                                                ...
                                                                <div class="card">
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="dropzone needsclick dz-clickable dz-started" action="/" id="dropzone-audio3">
                                                                            ...
                                                                            <div class="row" data-path="music/64fdbcdbb4c6f___RABEE03.MP3">
                                                                                <div class="col-md-12 col-12 d-flex justify-content-center">
                                                                                    <div class="dz-preview dz-file-preview w-100">
                                                                                        <div class="dz-details">
                                                                                            <div class="dz-thumbnail" style="width:95%"> <img data-dz-thumbnail="" class="w-100"> <span class="dz-nopreview">No preview</span>
                                                                                                <div class="dz-success-mark"></div>
                                                                                                <div class="dz-error-mark"></div>
                                                                                                <div class="dz-error-message"><span data-dz-errormessage=""></span></div>
                                                                                                <div class="progress">
                                                                                            ...
                                                                                            <div class="dz-filename" data-dz-name="">RABEE03.MP3</div>
                                                                                            <div class="dz-size" data-dz-size=""><strong>3</strong> MB</div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div> <a class="dz-remove" href="javascript:undefined;" data-dz-remove="">Remove file</a>
                                                                            </div>
                                                                            <div class="row" data-path="music/64fdbcdd34cc3___RABEE04.MP3">
                                                                                <div class="col-md-12 col-12 d-flex justify-content-center">
                                                                                    <div class="dz-preview dz-file-preview w-100">
                                                                                        <div class="dz-details">
                                                                                            <div class="dz-thumbnail" style="width:95%"> <img data-dz-thumbnail="" class="w-100"> <span class="dz-nopreview">No preview</span>
                                                                                            ...
                                                                                            <div class="dz-filename" data-dz-name="">RABEE04.MP3</div>
                                                                                            <div class="dz-size" data-dz-size=""><strong>3.2</strong> MB</div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div> <a class="dz-remove" href="javascript:undefined;" data-dz-remove="">Remove file</a>
                                                                            </div>
