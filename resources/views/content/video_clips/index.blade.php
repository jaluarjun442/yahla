  ...
  <div class="table-responsive text-nowrap">
    <table class="table">
      ...
      <tbody class="table-border-bottom-0">
        ...
        <tr>
          <td>{{$item['_id']}}</td>
          <td>{{ $item['artist']['first_name'] }} {{ $item['artist']['last_name'] }}</td>
                                ...
                                <div class="card">
                                  ...
                                  <div class="card-body">
                                    <div class="dropzone needsclick dz-clickable dz-started" action="/" id="dropzone-video2">
                                      ...
                                      <div class="row" data-path="video_clips/64fdbb812ed5a___BERO_BASS_feat._Xatar__Sivan_Perwer_-_Blick_Richtung_Sonne.mp4">
                                        <div class="col-md-12 col-12 d-flex justify-content-center">
                                          <div class="dz-preview dz-file-preview w-100">
                                            <div class="dz-details">
                                              <div class="dz-thumbnail" style="width:95%"> <img data-dz-thumbnail=""> <span class="dz-nopreview">No preview</span>
                                              ...
                                              <div class="dz-filename" data-dz-name="">BERO_BASS_feat._Xatar__Sivan_Perwer_-_Blick_Richtung_Sonne.mp4</div>
                                              <div class="dz-size" data-dz-size=""><strong>6.6</strong> KB</div>
                                            </div>
                                          </div>
...
{{-- Create Music model --}}
<x-modal id="createmusicModal" title="Create Video Clips" saveBtnText="Create" saveBtnType="submit" saveBtnForm="createForm" size="md">
